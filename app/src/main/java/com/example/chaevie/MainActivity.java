...
public class MainActivity extends Activity {
    ...
    private void calculateAndRenderResult() {
        try {
            TipCalculator.CalculationResult result = TipCalculator.calculate(
                    textOf(billAmountInput),
                    textOf(tipPercentInput),
                    textOf(peopleCountInput),
                    selectedRounding());
    ...
    private void renderResult(TipCalculator.CalculationResult result) {
        tipAmountView.setText(getString(R.string.tip_amount_value, formatMoney(result.getTipAmount())));
        totalAmountView.setText(getString(R.string.total_amount_value, formatMoney(result.getTotalAmount())));
        perPersonAmountView.setText(getString(R.string.per_person_amount_value, formatMoney(result.getAmountPerPerson())));
    }
